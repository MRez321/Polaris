          ...
          <div className="glass-panel p-6 rounded-2xl shadow-xl border border-[#CEAE80]/30">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-black text-base text-stone-900 dark:text-white">{name || 'پولاریس استایل'}</h4>
                <p className="text-xs text-stone-500 dark:text-gray-400 mt-0.5">{slogan || 'کارگاه پوشاک پولاریس'}</p>
                <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mt-2 text-[11px] text-stone-500 dark:text-gray-400">
                  {phone && (
                  ...
                  {instagram && <span dir="ltr">@{instagram}</span>}
                  {telegram && <span dir="ltr">t.me/{telegram}</span>}
                </div>
              </div>
              <button
                type="button"
            ...
            {([
              {
                ...
                title: 'مشخصات برند',
                desc: 'نام، شعار و راه‌های ارتباطی کارگاه',
              },
              {
                id: 'gallery' as const,
                icon: <Images className="w-5 h-5" />,
                title: 'گالری تصاویر',
                desc: 'مدیریت تصاویر کارگاه و محصولات',
              },
              {
                id: 'trash' as const,
                icon: <Trash2 className="w-5 h-5" />,
                title: 'سطل بازیافت',
                desc: 'بازیابی اطلاعات حذف‌شده',
              },
              {
                id: 'system' as const,
                icon: <Database className="w-5 h-5" />,
                title: 'سامانه برخط',
                desc: 'وضعیت پایگاه داده و اپلیکیشن موبایل',
              },
              {
                id: 'users' as const,
                icon: <Users className="w-5 h-5" />,
                title: 'مدیریت کاربران',
                desc: 'نقش‌ها و دسترسی کاربران سامانه',
              },
              {
                id: 'notifications' as const,
                icon: <Bell className="w-5 h-5" />,
                title: 'اطلاع‌رسانی',
                desc: 'تلگرام و پیامک ملی‌پیامک',
              },
            ] as const).map((card) => (
              <button
                key={card.id}
              ...
              >
                ...
                <span className="text-[11px] text-stone-500 dark:text-gray-400 leading-relaxed">{card.desc}</span>
              </button>
            ))}
          </div>
