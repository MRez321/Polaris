...
// Official multi-color Google "G" (lucide ships no brand icons).
...
// Redirect-based OAuth: on success the browser leaves the SPA for Google, so
// the button keeps its loading state until navigation happens.
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ label }) => {
