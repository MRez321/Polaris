...
export async function listConsignments(_req, res) {
...
export async function submitReturn(req, res) {
    ...
    logAudit(req.auth ?? null, 'create', 'return', `مرجوعی واگذاری ${updatedConsignment.code} به ارزش ${returnRecord.totalReturnAmount} ثبت شد`);
    res.status(201).json({
