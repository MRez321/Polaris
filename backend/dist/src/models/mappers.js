...
export function toItemDto(row, categoryLabel) {
    return {
        id: row.id,
        code: row.code,
        name: row.name,
...
export function toSellerDto(row) {
    return {
        id: row.id,
        code: row.code,
        name: row.name,
...
export function toConsignmentDto(row) {
    return {
        id: row.id,
        code: row.code,
...
export function toReturnDto(row) {
    return {
        id: row.id,
...
export function toExpenseDto(row) {
    return {
        ...
        costAllocation: row.costAllocation,
...
export function toProfitDto(row) {
    return {
        id: row.id,
