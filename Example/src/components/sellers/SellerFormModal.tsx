...
import { Seller, BankAccountInfo } from '../../types';
import { Plus, Trash2, Camera, CreditCard, Shield, Phone, MapPin, User, Check, Copy, Building2, ChevronDown, ChevronUp } from 'lucide-react';
