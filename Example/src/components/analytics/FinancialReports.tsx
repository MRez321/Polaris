...
import { DashboardStats, Seller, Consignment, PaymentRecord, GarmentItem } from '../../types';
...
export const FinancialReports: React.FC<FinancialReportsProps> = ({
  ...
  const { filteredConsignments, filteredPayments, filteredHandoversTotal, filteredPaymentsTotal } =
    useMemo(() => {
      const now = new Date();
